...
export const INITIAL_DATA: AppData = {
  ...
  customers: [],
  suppliers: [
    { id: 's1', name: 'Deportes El Campeón', document: '800123456-1', phone: '3001234567', email: 'ventas@campeon.com', address: 'Calle 10 #5-20', updatedAt: Date.now() }
  ],
  promotions: [
    { id: 'pr1', name: 'Descuento Inauguración', discountPercentage: 10, isActive: true }
  ],
  pointsConfig: {
    pointsPerThousand: 1, // 1 punto por cada $1,000 COP
    valuePerPoint: 100 // Cada punto vale $100 COP para redención
  },
  sales: [],
  purchases: [],
